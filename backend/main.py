...
from presentation.api.routes import layer1, layer2, chat, trading_agent, symbols, discussions, smart_money
...
async def lifespan(app: FastAPI):
    ...
    start_scheduler(layer1_run, layer2_refresh, discussion_usecase.execute)
